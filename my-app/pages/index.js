...
export default function Home() {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 5) {
      window.alert("Change the network to Goerli, for the adress : ", );
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            Congrats ! You have {tokensToBeClaimed * 1} Crypto-Dev NFT. 
          </div>
          <div className={styles.description}>
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <img className={styles.imageIcon} src="./token.png" />
        </div>        
        <div>
